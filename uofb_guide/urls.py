...
from news.views import ArticleViewSet, AnouncementViewSet
from student_guide.views import GuideViewSet
...
router.register(r'news/anouncement', AnouncementViewSet) # Anouncements
